...
<body>
    ...
    <div id="image1"><a href="https://www.jindalsteelpower.com/"><body onload = "startTimer()">
       <img id="img" src="image_download.png"/></a></div>
        ...
        <div id="header2"><p>You can edit the Work Order here</p></div><br>

        <div id="form">
                <br>
                <form action="html_edit1.php" method="POST" >
                ...
                <hr height="2 px">
                    <label><center><b>PRESS "EDIT" ONLY IF YOU ARE SURE.</b></center></label><br><br>
                <br><div id="button"><input type="Submit" value="Edit Work Order" style="width: 90%; height: 50px; border-radius: 25px; border: none; font-family:cursive; font-size: 30px; background-color: azure;"></div>
            </form>
        </div>
