...
<body>
    <div id="body">
        ...
        <div id="image"><img src="download.png" ></div><div id="image-text">    Registration Form</div><br>
        ...
        <div id="form">
            ...
            <label>First Name</label><br>
                <input type="text" name="f_name" style="width:90%; height: 30px;"><br><br>
                <label>Last Name</label><br>
                <input type="text" name="l_name" style="width:90%; height: 30px;"><br><br>
                <label>Email</label><br>
                <input type="text" name="email" style="width:90%; height: 30px;"><br><br>
                <label>Employee Code</label><br>
                <input type="text" name="e_code" style="width:90%; height: 30px;"><br><br>
                <label>Password</label><br>
                <input type="text" name="pwd" style="width:90%; height: 30px;"><br><br><br>
